CREATE TABLE IF NOT EXISTS "media_drops" (
...
--> statement-breakpoint
ALTER TABLE "intel_companies" ADD COLUMN IF NOT EXISTS "directory" text DEFAULT 'crypto' NOT NULL;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "media_drops_company_idx" ON "media_drops" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "media_drops_status_idx" ON "media_drops" USING btree ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "media_drops_created_at_idx" ON "media_drops" USING btree ("created_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "pulse_agg_period_topic_uq" ON "pulse_aggregations" USING btree ("period","period_start","topic");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "pulse_tweets_tweet_id_uq" ON "pulse_tweets" USING btree ("tweet_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pulse_tweets_topic_idx" ON "pulse_tweets" USING btree ("topic");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pulse_tweets_created_at_idx" ON "pulse_tweets" USING btree ("tweet_created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pulse_tweets_author_idx" ON "pulse_tweets" USING btree ("author_username");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pulse_xrpl_bridge_type_idx" ON "pulse_xrpl_bridge_mentions" USING btree ("bridge_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "pulse_xrpl_bridge_captured_idx" ON "pulse_xrpl_bridge_mentions" USING btree ("captured_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "x_tweet_analytics_company_posted_idx" ON "x_tweet_analytics" USING btree ("company_id","posted_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "intel_companies_directory_idx" ON "intel_companies" USING btree ("directory");
