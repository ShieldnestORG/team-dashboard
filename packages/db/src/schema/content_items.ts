...
export const contentItems = pgTable(
  "content_items",
  {
    ...
    // Partner Network attribution: set when this row was generated by the
    // partner:mentions:generate cron for a specific partner, so the monthly
    // per-partner mention quota can be counted. NULL for all non-partner content.
  ...
  (table) => ({
    ...
    partnerCreatedIdx: index("content_items_partner_created_idx").on(
      table.partnerId,
      table.createdAt,
    ),
  }),
