...
export const TX_PROMO_TWEETS: PromoTweet[] = [
  ...
  {
    text: "The TX ecosystem deserves great tooling. That's why shieldnest.io and coherencedaddy.com partnered to build tokns.fi — a home for everything TX.",
    hashtags: ["TX", "tokns", "ShieldNest", "CoherenceDaddy"],
    venture: "tokns",
    category: "community",
  },
...
export const TX_PROMO_THREADS: PromoThread[] = [
  {
    tweets: [
      ...
      "Built by ShieldNest (shieldnest.io) and Coherence Daddy (coherencedaddy.com), tokns.fi is community infrastructure, not a VC exit strategy.",
  ...
  },
  {
    tweets: [
      ...
      "We're the team behind coherencedaddy.com's 27 free tools and shieldnest.io's privacy-first infrastructure. We build things people actually use.",
