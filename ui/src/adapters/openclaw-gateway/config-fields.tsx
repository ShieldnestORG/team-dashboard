...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="Team Dashboard API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. Team Dashboard persists a device key during onboarding so pairing approvals
