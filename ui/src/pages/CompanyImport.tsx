...
export function CompanyImport() {
  ...
  const localZipHelpText =
    "Upload a .zip exported directly from Team Dashboard. Re-zipped archives created by Finder, Explorer, or other zip tools may not import correctly.";
      ...
      <div className="border-b border-border px-5 py-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Choose a GitHub repo or upload a local Team Dashboard zip package.
          </p>
        </div>
