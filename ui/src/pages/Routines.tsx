  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Team Dashboard could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Team Dashboard could not start the routine run.",
        tone: "error",
      });
    },
  });
        ...
        <DialogContent showCloseButton={false} className="max-w-3xl gap-0 overflow-hidden p-0">
          ...
          <div className="flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, Team Dashboard takes you straight to trigger setup for schedules, webhooks, or internal runs.
            </div>
