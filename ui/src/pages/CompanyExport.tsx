...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://github.com/ShieldnestORG/team-dashboard) package.");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Team Dashboard](https://github.com/ShieldnestORG/team-dashboard) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Team Dashboard](https://github.com/ShieldnestORG/team-dashboard) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
