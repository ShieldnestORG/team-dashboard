...
/**
 * Numbered step heading for the Compose form — same numbered-circle language
 * as FlowStepper/FunnelLifecycleStepper, so "what do I do, in what order" is
 * explicit for a first-time user.
 */
          ...
          <CardContent className="space-y-4">
            ...
            <label className="block space-y-1">
              <div className="flex items-end justify-between gap-2">
                <StepHeader n={2} title="Write your post" sub="This exact text is what goes out." />
            ...
            <div className="space-y-2">
              <StepHeader
                n={4}
                title="Choose when it goes out"
                sub="Leave the box ticked to send it right away, or untick it to pick a day and time."
              />
