...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The Team Dashboard CLI can now finish authentication on the requesting machine.
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">Approve Team Dashboard CLI access</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          A local Team Dashboard CLI process is requesting board access to this instance.
        </p>
