...
function sourceMeta(sourceBadge: CompanySkillSourceBadge, sourceLabel: string | null) {
  ...
  switch (sourceBadge) {
    ...
    case "paperclip":
      return { icon: Paperclip, label: sourceLabel ?? "Team Dashboard", managedLabel: "Team Dashboard managed" };
    default:
  ...
  const createSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        tone: "success",
        title: "Skill created",
        body: `${skill.name} is now editable in the Team Dashboard workspace.`,
      });
    },
    onError: (error) => {
      pushToast({
