...
// Canonical company-structure diagram. Single source of truth — the server reads
// the same .mmd file at boot via structure-sync and upserts it as the persisted
// document, so editing the .mmd + redeploying is the only step needed.
import DEFAULT_DIAGRAM from "../../../docs/architecture/company-structure.mmd?raw";
