...
// ---------------------------------------------------------------------------
// Visual backend registry — auto-enables backends based on env vars
// ---------------------------------------------------------------------------
...
/** Pick the best available backend for the requested capability */
export function pickBackend(capability: VisualCapability): VisualBackend | undefined {
  ...
  // Prefer gemini for video, either for image
  if (capability === "video") {
