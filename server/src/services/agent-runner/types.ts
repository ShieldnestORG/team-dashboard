...
// Closed set — MUST match the CHECK constraint in migration 0136.
...
// MUST match migration 0136's severity CHECK.
export type ReportSeverity = "info" | "warning" | "error" | "critical";

// MUST match migration 0136's purpose CHECK on university_agent_usage.
