...
// ---------------------------------------------------------------------------
// Context fetcher (reuses intel embedding pattern)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Determine capability needed from content type
// ---------------------------------------------------------------------------
...
export function visualContentService(
  ...
  // Wire up job completion to store assets and update queue
  ...
  async function generate(opts: {
    ...
    // Enrich prompt with intel context
    ...
    // If synchronous result (image from grok), store immediately
