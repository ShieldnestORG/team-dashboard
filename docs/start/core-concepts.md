...
Team Dashboard organizes autonomous AI work around six key concepts.
...
One Team Dashboard instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by Team Dashboard.
