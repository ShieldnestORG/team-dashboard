...
Manage companies within your Team Dashboard instance.
...
Company logo uploads use the normal Team Dashboard attachment size limit.
...
| `logoUrl` | string | Optional Team Dashboard asset content path for the stored logo image |
