...
- [x] **4. Migration `0106_creditscore_reports_raw_data.sql`**
  - **Files:** `packages/db/src/migrations/0106_creditscore_reports_raw_data.sql`, `packages/db/src/schema/creditscore.ts`
