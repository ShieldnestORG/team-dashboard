...
- Running a Python script that calls the Team Dashboard API
...
1. Team Dashboard spawns the configured command as a child process
2. Standard Team Dashboard environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Team Dashboard API and perform work.
