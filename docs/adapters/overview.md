...
summary: What adapters are and how they connect agents to Team Dashboard
---

Adapters are the bridge between Team Dashboard's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Team Dashboard:
