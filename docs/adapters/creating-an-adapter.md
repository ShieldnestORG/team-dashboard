...
Build a custom adapter to connect Team Dashboard to any agent runtime.
...
Make Team Dashboard skills discoverable to your agent runtime without writing to the agent's working directory:
