...
Team Dashboard tracks every token spent by every agent and enforces budget limits to prevent runaway costs.
...
Team Dashboard enforces budgets automatically:
