...
Team Dashboard supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Team Dashboard?** Use `local_trusted` (the default)
