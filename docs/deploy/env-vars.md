...
| `UNIVERSITY_STRIPE_PRICE_ID` | Optional | VPS | Bare Starwise price ID for University ($50/mo). Fallback only — University resolves by `lookup_key=university_monthly` first. Leave unset to keep the lookup_key path canonical. |
